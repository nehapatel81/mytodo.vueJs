            ...
            <div class="card mb-3">
              <div class="card-body">
                ...
                <form class="row g-3 needs-validation" novalidate>
                  ...
                  <div class="col-12">
                    <p class="small mb-0">
                      Don't have account? <a href="#" @click="onDontHaveAccountClicked">Create an account</a>
                    </p>
                  </div>
                </form>
              </div>
...
export default {
  ...
  data() {
    return {
      userName: 'nehavpatel81@gmail.com',
      password: 'neha123'
    }
  },
  methods: {
    async onLoginClicked() {
      ...
      const sucess = await this.userStore.login(this.userName, this.password);
